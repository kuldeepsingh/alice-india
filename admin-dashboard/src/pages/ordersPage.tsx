...
const mockOrders = [
  { id: 'ORD001', symbol: 'INFY', quantity: 100, price: '1,850', status: 'Filled', type: 'Buy', time: '09:30 AM' },
  { id: 'ORD002', symbol: 'TCS', quantity: 50, price: '3,450', status: 'Pending', type: 'Sell', time: '10:15 AM' },
  { id: 'ORD003', symbol: 'RELIANCE', quantity: 25, price: '2,890', status: 'Filled', type: 'Buy', time: '11:45 AM' },
  { id: 'ORD004', symbol: 'WIPRO', quantity: 200, price: '380', status: 'Cancelled', type: 'Sell', time: '02:30 PM' },
]
              ...
              <TableBody>
                {mockOrders.map((order) => (
                  <TableRow key={order.id} sx={{ borderBottom: `1px solid ${THEME_PRO.border}` }}>
                    ...
                    <TableCell sx={{ color: THEME_PRO.textSecondary }}>{order.time}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
